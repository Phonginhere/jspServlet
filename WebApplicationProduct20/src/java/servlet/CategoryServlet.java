...
//        }
        ...
        request.setAttribute("displayCategories", categories);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id_cate != null) {
            int id = Integer.parseInt(id_cate);
            
            Query query = em.createNamedQuery("Product.findAll", Category.class);
            ...
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/categoryDetails.jsp");
            dispatcher.forward(request, response);
        }
